...
function ActivitysSec() {
  return (
    <>
      <div className='bg-gray-100 w-full h-44 rounded-md p-2 flex flex-col mb-5 drop-shadow-md'>
        ...
        <div className='flex items-center pl-5 gap-5 py-2 border-inherit pb-4 border-b-2'>
          ...
          <div className='grow flex'>
            <input type="text" name="" id="" placeholder='What are you thinking ? 😁' className='w-3/5 rounded-md p-2 outline-none' />
          </div>
